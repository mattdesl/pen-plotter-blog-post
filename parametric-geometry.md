Over the last several months, I've been exploring different ways to render my code and algorithms as _physical_ outputs. I'm interested in the idea of real, tangigble objects that are no longer bound by the generative systems that created them.
